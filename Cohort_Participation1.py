...
#Renaming the participation years to one year that will reflect the entrance of each student per cohort. 
...
#Goal: This section will separate the females and the males in this cohort by showing the percentages and status of each student
                             
#Creating a dataframe showing only the 2015 cohort


#Locating the cells that have n.a. that signalizes the unknown status of the students in the 2015 cohort
...
P2015F = P2015.drop(['P2016', 'P2017', 'P2018', 'P2019', 'P2020', 'P2021'], axis=1)
...
#This will be showing the number of students entering the program during this year.
...
test = test.dropna()
P2016F = test.drop(['P2015', 'P2017', 'P2018', 'P2019', 'P2020', 'P2021'], axis=1)
print(P2016F)
...
#Creating a Pie Chart that Shows the Aggregate of Male and Females
P2016F.groupby(['Sex']).sum().plot(title="2016 Cohort Male vs Females in Program", kind='pie', y='Number of Years in Program', autopct='%1.0f%%')
...
test1 = test1.dropna()
P2017F = test1.drop(['P2015', 'P2016', 'P2018', 'P2019', 'P2020', 'P2021'], axis=1)
...
#Creating a Pie Chart that Shows the Aggregate of Male and Females
P2017F.groupby(['Sex']).sum().plot(title="2017 Cohort Male vs Females in Program", kind='pie', y='Number of Years in Program', autopct='%1.0f%%')
...
test2 = test2.dropna()
P2018F = test2.drop(['P2015', 'P2016', 'P2017', 'P2019', 'P2020', 'P2021'], axis=1)
print(P2018F)
...
#Creating a Pie Chart that Shows the Aggregate of Male and Females
P2018F.groupby(['Sex']).sum().plot(title="2018 Cohort of Males vs Females in Program", kind='pie', y='Number of Years in Program', autopct='%1.0f%%')
...
test2 = test2.dropna()
P2019F = test2.drop(['P2015', 'P2016', 'P2017', 'P2019', 'P2020', 'P2021'], axis=1)
print(P2019F)
...
#Creating a Pie Chart that Shows the Aggregate of Male and Females
P2018F.groupby(['Sex']).sum().plot(title="2019 Cohort of Males vs Females in Program", kind='pie', y='Number of Years in Program', autopct='%1.0f%%')
...
test2 = test2.dropna()
P2020F = test2.drop(['P2015', 'P2016', 'P2017', 'P2019', 'P2020', 'P2021'], axis=1)
print(P2020F)
...
#Creating a Pie Chart that Shows the Aggregate of Male and Females
P2018F.groupby(['Sex']).sum().plot(title="2020 Cohort of Males vs Females in Program", kind='pie', y='Number of Years in Program', autopct='%1.0f%%')
